package com.zeroone_creative.goodsdb.view.widget;
...
public class ColorPickerDialog extends Dialog {
    ...
    private static class ColorPickerView extends View {
        ...
        private static float OK_X0 = - CENTER_X/2;
        private static float OK_X1 =   CENTER_X/2;
        private static float OK_Y0 = (float) (CENTER_X * 1.2);
        private static float OK_Y1 = (float) (CENTER_X * 1.5);
        ...
        ColorPickerView(Context c, OnColorChangedListener l, int color,int width,int height) {
            super(c);
            CENTER_X = width;
            CENTER_Y = height;
            OK_X0 = - CENTER_X/2;
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            Log.d("ox x0;","OK_X0:"+OK_X0+"OK_X1:"+OK_X1+"OK_Y0:"+OK_Y0+"OK_Y1:"+OK_Y1);
            if(r <= CENTER_X) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(new ColorPickerView(getContext(), l, mInitialColor,width,height), lp);
        setTitle("- Color -");
    }
